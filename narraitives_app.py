...
#     tokenizer = AutoTokenizer.from_pretrained("facebook/bart-large-mnli", token=token)
#     model = AutoModelForSequenceClassification.from_pretrained("facebook/bart-large-mnli", token=token)
# 
#     # Create a pipeline from the loaded model and tokenizer
#     return pipeline("zero-shot-classification", model=model, tokenizer=tokenizer, device='cpu')
# 
# 
